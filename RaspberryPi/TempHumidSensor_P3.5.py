...
def main():
	...
	while True:
		...
		if result:
			...
			print("humidity: %s %%,  Temperature: %s F" % (humidity, temperatureF))
			...
			try:
				r = requests.post(url+"/?roomAddress="+roomAddress+"&temperature="+str(temperatureF)+"&humidity="+str(humidity), headers=headers)
